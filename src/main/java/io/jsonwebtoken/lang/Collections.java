...
public final class Collections {
     ...
     * @see io.jsonwebtoken.lang.Objects#toObjectArray(Object)
     */
    public static List arrayToList(Object source) {
        return Arrays.asList(io.jsonwebtoken.lang.Objects.toObjectArray(source));
    }
    ...
    public static void mergeArrayIntoCollection(Object array, Collection collection) {
        ...
        Object[] arr = io.jsonwebtoken.lang.Objects.toObjectArray(array);
        for (Object elem : arr) {
            collection.add(elem);
        }
    }
    ...
    public static boolean contains(Iterator iterator, Object element) {
        if (iterator != null) {
            while (iterator.hasNext()) {
                ...
                if (io.jsonwebtoken.lang.Objects.nullSafeEquals(candidate, element)) {
                    return true;
                }
            }
        }
    ...
    public static Object findValueOfType(Collection<?> collection, Class<?>[] types) {
        if (isEmpty(collection) || io.jsonwebtoken.lang.Objects.isEmpty(types)) {
            return null;
        }
