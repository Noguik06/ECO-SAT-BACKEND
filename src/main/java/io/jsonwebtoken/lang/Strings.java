...
public final class Strings {
    ...
    public static String[] addStringToArray(String[] array, String str) {
        if (io.jsonwebtoken.lang.Objects.isEmpty(array)) {
    ...
    public static String[] concatenateStringArrays(String[] array1, String[] array2) {
        if (io.jsonwebtoken.lang.Objects.isEmpty(array1)) {
            return array2;
        }
        if (io.jsonwebtoken.lang.Objects.isEmpty(array2)) {
            return array1;
        }
    ...
    public static String arrayToDelimitedString(Object[] arr, String delim) {
        if (io.jsonwebtoken.lang.Objects.isEmpty(arr)) {
            return "";
        }
        if (arr.length == 1) {
            return io.jsonwebtoken.lang.Objects.nullSafeToString(arr[0]);
        }
        StringBuilder sb = new StringBuilder();
